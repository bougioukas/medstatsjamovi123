...
#| warning: false
#| label: fig-histo3
#| fig-cap: Histogram of age of the participants by treatment group in @farndon2013 study.
#| fig-width: 7.5
#| fig-height: 5.0
...
dat_corn |>
  ggplot(aes(x = age)) +
  geom_histogram(aes(fill=group), binwidth=10, color="#8fb4d9", alpha=0.6) +
  ggtitle("Histohram") +
  labs(y="Frequency") +
  theme_minimal() +
  ggsci::scale_fill_jco() +
  ...
  annotate('text', x = 50, y = 25, label = 'mean', color = '009e73') +
  annotate('text', x = 75, y = 25, label = 'median', color = 'grey') +
  facet_grid(~group) +
