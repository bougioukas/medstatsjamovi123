...
* If the distribution is **symmetric** (mean=md=mode) (@fig-skew b), then in general the **mean** is the better summary statistic. 
...
Thus, the following format is recommended for reporting summary statistics:
