...
$$\\[1cm]$$ @tbl-corn presents a typical table with some of the basic characteristics (variables) of patients entered into @farndon2013 study.
...
$$\\[0.1cm]$$ The degree of measurement accuracy and the type of data are both important in relation to carrying out a proper statistical analysis.
...
$$\\[0.2cm]$$ **2nd case: Odd observations**
...
$$\\[0.2cm]$$ **C. Variance and Standard Deviation**
