...
#| warning: false
#| label: fig-histo3
#| fig-cap: Histogram of age of participants in @farndon2013 study by treatment group.
#| fig-width: 7.5
#| fig-height: 5.0
...
#| warning: false
#| label: fig-boxplot3
#| fig-cap: A box plot of age of the participants in @farndon2013 study by treatment group.
#| fig-width: 5.5
#| fig-height: 4.0
...
Scatter plots are two dimensional, showing the association between two continuous variables (@fig-scatterplot a). By coloring the data or using different symbols by a third variable, scatter plots can provide additional dimensions (@fig-scatterplot b).
...
#| fig-cap: Association between age and baseline pain by gender @farndon2013 study.
#| fig-width: 8.5
#| fig-height: 4.0
