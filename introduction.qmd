...
#| warning: false
#| label: fig-histo1
#| fig-cap: Histogram of age of the participants in @farndon2013 study (a) histohram (b) density plot.
#| fig-width: 7.5
#| fig-height: 5.0
...
h1 <- dat_corn |>
  ...
  ggtitle("Histohram") +
  geom_vline(aes(xintercept=mean(age)), color="blue", linetype="dashed", size=0.8) +
  ...
  annotate('text', x = 52, y = 43, label = 'mean', color = 'blue') +
...
h2 <- dat_corn |>
  ...
  annotate('text', x = 52, y = 0.025, label = 'mean', color = 'blue') +
...
If we have too many bins, then the data distribution will look rough, and it will be difficult to discern the signal from the noise (@fig-histo1 a). On the other hand, with too few bins, the histogram will lack the details needed to discern any useful pattern from the data (@fig-histo1 b).
:::
