...
$\color{orange}{Orange\ color\ with\ a\ traffic\ cone\ icon}$: Additional information that can be expanded by the user (**click on it**).
...
$\color{grey}{Grey\ color}$: Exercises with embedded solution.
