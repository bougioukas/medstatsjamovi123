...
## **Example: Raw data from salicylic acid plasters for treatment of foot corns**
...
**Nominal categorical data** are data that one can name and put into categories. They are not measured but simply **counted**. They often consist of **unordered** 'either--or' type observations which have two categories and are often know as **binary**. For example: dead or alive; male or female; cured or not cured; pregnant or not pregnant. In @farndon2013 study gender is a binary variable. However, nominal categorical data often can have **more than two categories**, for example, blood group A, B, AB, 0; country of origin; ethnic group; eye color. 
@farndon2013 study recorded data of the participants treated at each of the **seven centers** in each of the two randomized groups.
