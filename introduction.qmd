...
|                            |                  |                  |                  |                  |                   |                   |                   |                   |                    |                    |                    |                    |                     |                     |                     |                      |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| **Ordered corn size (mm)** | $\color{red}{1}$ | $\color{red}{2}$ | $\color{red}{2}$ | $\color{red}{2}$ | $\color{blue}{2}$ | $\color{blue}{2}$ | $\color{blue}{3}$ | $\color{blue}{3}$ | $\color{green}{3}$ | $\color{green}{3}$ | $\color{green}{4}$ | $\color{green}{4}$ | $\color{orange}{5}$ | $\color{orange}{6}$ | $\color{orange}{6}$ | $\color{orange}{10}$ |

: Calculating quartiles for th corn size data {#tbl-quartiles}
