...
Distributions with positive excess kurtosis are called *leptokurtic* (@fig-kurtosis a). If the measure of excess kurtosis is close to 0 the distribution is mesokurtic (@fig-kurtosis b). Finally, distributions with negative excess kurtosis are called *platykurtic* (@fig-kurtosis c).
