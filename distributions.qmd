...
$$P(C|SM) = \frac{P(SM|C)· P(C)}{P(SM)} = \frac{0.4· 0.001}{0.25}= 0.0016$$
Therefore, the probability of lung cancer increases from 0.001 to
0.0016 for smokers. That is, the probability becomes 60% higher than the overall probability of lung cancer.
