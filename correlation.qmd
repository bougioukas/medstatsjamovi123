...
pcor4 <- dat4|>
  ggplot(aes(X1, X2)) +
  geom_point() +
  ggtitle(paste0("Correlation r=", round(cor4, digits=1))) +
  theme_steve()
...
pcor5 <- dat5|>
  ggplot(aes(X1, X2)) +
  geom_point() +
  ggtitle(paste0("Correlation r=", round(cor5, digits=1))) +
  theme_steve()
...
pcor6 <- dat6|>
  ggplot(aes(X1, X2)) +
  geom_point() +
  ggtitle(paste0("Correlation r=", round(cor6, digits=1))) +
  theme_steve()
...
pcor7 <- dat7|>
  ggplot(aes(X1, X2)) +
  geom_point() +
  ggtitle(paste0("Correlation r=", round(cor7, digits=1))) +
  theme_steve()
...
pcor8 <- dat8|>
  ggplot(aes(X1, X2)) +
  geom_point() +
  ggtitle(paste0("Correlation r=", round(cor8, digits=1))) +
  theme_steve()
...
pcor9 <- dat9|>
  ggplot(aes(X1, X2)) +
  geom_point() +
  ggtitle(paste0("Correlation r=", round(cor9, digits=1))) +
  theme_steve()
